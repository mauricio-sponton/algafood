...
public @interface CheckSecurity {
	...
	public @interface Pedidos {
	    ...
	    @PreAuthorize("hasAuthority('SCOPE_READ') and isAuthenticated()")
	    @PostAuthorize("hasAuthority('CONSULTAR_PEDIDOS') or @algaSecurity.getUsuarioId() == returnObject.cliente.id or @algaSecurity.gerenciaRestaurante(returnObject.restaurante.id)")
	    @Retention(RUNTIME)
	    @Target(METHOD)
