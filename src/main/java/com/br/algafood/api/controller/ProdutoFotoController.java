...
import com.br.algafood.domain.service.FotoStorageService.FotoRecuperada;
...
public class ProdutoFotoController implements ProdutoFotoControllerOpenApi {
	...
	public FotoProdutoDTO atualizarFoto(@PathVariable Long restauranteId, @PathVariable Long produtoId,
			@Valid ProdutoFotoInputDTO produtoFotoInputDTO, @RequestPart(required = true) MultipartFile arquivo) throws IOException {
